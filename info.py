...
# Bot information
SESSION = environ.get('SESSION', 'roaroic')
API_ID = int(environ.get('API_ID', '30957124'))
API_HASH = environ.get('API_HASH', '38d0b82769881fa358257222b7ac8785')
BOT_TOKEN = environ.get('BOT_TOKEN', "8943331192:AAGRXx6-aohTpPxrNwaPzH-149G8WAXxAWc")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6211133128').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1004379059015'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001553577227').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1004476058811') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://one2yadavv_db_user:vevaOVyOk7uGoEQM@roaoric.ckkknpy.mongodb.net/?appName=roaoric")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "roaoric")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+vjB8ArkS8Co3NTM1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/roaroic0')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'roaroic_disscussion') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/roaroic')
